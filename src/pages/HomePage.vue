  ...
  <div class="container-fluid">
    ...
    <div class="content-lessons">
      ...
      <div class="content-lessons__cards">
        <LessonCardsVue :cards="this.searchedMissedLessons" v-if="!this.isLoading"></LessonCardsVue>
    ...
    <div class="content-podcasts">
      ...
      <PodcastCardsVue :cards="this.podcasts" v-if="!this.isLoading"></PodcastCardsVue>
      <Spinner v-else></Spinner>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    this.fetchLessonsAll(), this.fetchPodcasts();
  },
};
</script>
