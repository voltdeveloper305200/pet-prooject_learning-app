                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                    ...
                    <div class="details-content">
                        ...
                        <div class="details-content__description">
                            <p>
                                In this lesson, you use navigation controllers
                                and segues to create the navigation flow of the
                                FoodTracker app. At the end of the lesson,
                                you’ll have a complete navigation scheme and
