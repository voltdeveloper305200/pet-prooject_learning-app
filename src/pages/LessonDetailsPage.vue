      ...
      <div class="row">
              ...
              <div class="lesson-info">
                ...
                <div class="lesson-info__bottom">
                  ...
                  <div class="lesson-feedback">
                    ...
                    <div
                      class="lesson-feedback__dislikes"
                      @click="dislikesControl"
                      :class="{
                        active: activeDislike,
                      }"
                    >
                      <svg
                        width="24"
        ...
        <div class="col-lg-4 col-md-12 col-sm-12">
          ...
          <div class="lessons-list">
            ...
            >
              ...
              <div class="lesson-item__description">
                <router-link :to="`${lesson.id}`">{{ lesson.title }}</router-link>
                <p>{{ lesson.time }} мин</p>
                <hr />
              </div>
            </div>
          ...
          <div class="details-btn mt-5">
            <button :disabled="disabled" @click="makeCompleteLesson">
  ...
  methods: {
    ...
    getLessonDetailsData() {
      if (this.$route.params.id) {
        ...
        this.authorName = this.selectedLesson.authorName;
        this.authorAvatar = this.selectedLesson.authorAvatar;
        this.likes = this.selectedLesson.likes;
        this.dislikes = this.selectedLesson.dislikes;
    ...
    async makeCompleteLesson() {
      if (this.selectedLesson.isCompleted === false) {
        this.waiting = true;
        this.disabled = true;
        await axios.put(`http://localhost:8001/lessons/${this.selectedLesson.id}`, {
          ...this.selectedLesson,
          isCompleted: true,
        });
        this.waiting = false;
    ...
    async likesControl() {
      ...
      if (this.activeLike) {
        ...
        this.selectedLesson.likes = this.likes += 1;
      }
      if (!this.activeLike) {
        await axios.put(`http://localhost:8001/lessons/${this.selectedLesson.id}`, {
          ...this.selectedLesson,
    ...
    async dislikesControl() {
      ...
      if (this.activeDislike) {
        ...
        this.selectedLesson.dislikes = this.dislikes += 1;
      }
      if (!this.activeDislike) {
        await axios.put(`http://localhost:8001/lessons/${this.selectedLesson.id}`, {
          ...this.selectedLesson,
